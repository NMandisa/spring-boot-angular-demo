...
import za.co.mkhungo.exception.OrderTrackingException;
...
public class OrderTrackingExceptionHandler {
  @ExceptionHandler(value = {OrderTrackingException.class})
  public final ResponseEntity<?> handleOrderTrackingException(OrderTrackingException ex) {
