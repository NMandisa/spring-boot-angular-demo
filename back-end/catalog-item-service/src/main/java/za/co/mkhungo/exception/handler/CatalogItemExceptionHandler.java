...
import za.co.mkhungo.exception.CatalogItemException;
...
@Slf4j
public class CatalogItemExceptionHandler {
  @ExceptionHandler(value = {CatalogItemException.class})
  public final ResponseEntity<?> handleCatalogItemException(CatalogItemException ex) {
