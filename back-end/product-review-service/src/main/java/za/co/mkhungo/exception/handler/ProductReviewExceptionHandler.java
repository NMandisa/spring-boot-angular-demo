...
import za.co.mkhungo.exception.ProductReviewException;
...
public class ProductReviewExceptionHandler {
  @ExceptionHandler(value = {ProductReviewException.class})
  public final ResponseEntity<?> handleProductReviewException(ProductReviewException ex) {
