...
import za.co.mkhungo.exception.OrderReturnException;
...
@Slf4j
public class OrderReturnExceptionHandler {
  @ExceptionHandler(value = {OrderReturnException.class})
  public final ResponseEntity<?> handleOrderReturnException(OrderReturnException ex) {
