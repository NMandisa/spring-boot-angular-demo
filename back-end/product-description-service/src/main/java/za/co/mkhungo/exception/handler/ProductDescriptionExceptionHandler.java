...
import za.co.mkhungo.exception.ProductDescriptionException;
...
@Slf4j
public class ProductDescriptionExceptionHandler {
  @ExceptionHandler(value = {ProductDescriptionException.class})
  public final ResponseEntity<?> handleProductDescriptionException(ProductDescriptionException ex) {
